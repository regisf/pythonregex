...
(function() {
  var Model, cApplication, cMessageDialog, cModelAjax, cModelSocket, cObject, cOptionDialog, cOptionDialogModel, cUIView,
  ...
  cApplication = (function() {
    function cApplication() {
      ...
      this.model.connect(Model.Signals.SendError, function(msg) {
  ...
  */
  ...
  cModelSocket = (function(_super) {
    ...
    cModelSocket.prototype.sendRegex = function(regex, content, method, options, sub, count) {
      ...
      return socket.onopen = function(e) {
